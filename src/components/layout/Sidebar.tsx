...
export const Sidebar: React.FC<SidebarProps> = ({ isMobileOpen, onCloseMobile, onOpenPalette }) => {
  ...
  const sidebarContent = (
    <div
      className="flex flex-col h-full w-[216px] border-r select-none"
    ...
    >
      <div className="flex items-center gap-2.5 px-3.5 pt-3.5 pb-3">
        ...
        <div className="min-w-0">
          <div className="text-[13px] font-semibold tracking-tight" style={{ color: 'var(--color-tx)' }}>
            Supervision
          </div>
          <div
      ...
      <button
        ...
        style={{ borderColor: 'var(--color-ln)', color: 'var(--color-tx3)', background: 'var(--color-bg)' }}
      >
              ...
              return (
                ...
                >
                  <Icon
                    ...
                    style={{ color: active ? 'var(--color-acc)' : 'var(--color-tx3)' }}
                  />
      ...
      <div className="px-2.5 pb-2.5 mt-auto">
        <div className="h-px mb-2.5" style={{ background: 'var(--color-ln)' }} />
        <div className="flex items-center gap-2.5 px-1 py-1.5">
          ...
          >
            <div
              ...
              style={{ background: 'var(--color-acc-t)', borderColor: 'var(--color-acc-b)', color: 'var(--color-acc)' }}
            >
